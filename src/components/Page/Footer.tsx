        ...
        <section className="bg-[#38394f]">
            <div className="grid grid-cols-3 gap-28 py-11">
                <div className="flex items-center justify-center ">
                    ...
                    <div className="ml-3">
                        <p className="text-white mb-1 text-lg font-semibold">
                            Solutions Premium
                        </p>
                        <p className="text-[#737491] -mt-1">
                            + 10,000 clients utilisent nos solutions
                        </p>
                    </div>
                </div>
                <div className="flex items-center justify-center">
                    <svg className="w-7 h-auto mr-2" viewBox="0 0 24 24" fill="#a3c756" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        ...
                        <p className="text-[#737491] -mt-1">
                            Nous maîtrisons le e-commerce
                        </p>
                    </div>
                </div> 
                <div className="flex items-center justify-center">
                    <img src="/images/volant-logo.png" className="w-7 mr-2" />
                    <div>   
                        <p className="text-white mb-2 text-lg font-semibold">
                            Support Antifragile
                        </p>
                        <p className="text-[#737491] -mt-1">
                            Nous ne laissons jamais un client seul
                        </p>
                    </div>
