...
function Clients() {
    return (
        <section className="bg-[#f7f7fc] flex flex-col items-center">
            <div className="flex flex-row justify-center sm:text-4xl pt-20">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 sm:gap-7 mt-9 mb-11">
                <div className="text-center">
                    <div className="border border-solid w-full rounded-2xl bg-white flex justify-center">
