        ...
        <header className="w-full sticky top-0 z-50">
            ...
            <nav className="flex flex-row w-full bg-white shadow-sm ">
                <div className="flex flex-row items-center space-x-14 pl-7">
                    ...
                    <Link href="/blog" className="mt-2.6 text-custom-sm text-[#5a5b75] font-medium hover:text-[#a3c756] hidden sm:block">
                        Blog
                    </Link>
                </div>
                <div className="flex flex-row items-center ml-100 space-x-8">
                    ...
                    <svg fill="#c3c4c9" viewBox="0 0 30 27" xmlns="http://www.w3.org/2000/svg" className="w-6 h-auto hidden sm:block">
